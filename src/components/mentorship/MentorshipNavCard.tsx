    ...
    <div className="bg-white overflow-hidden shadow rounded-lg">
      <div className="p-5 bg-indigo-50 border-b border-indigo-100">
        <div className="flex items-center">
          ...
          <div className="ml-4">
            ...
            <p className="text-sm text-gray-500">Connect with mentors to accelerate your learning</p>
          </div>
        </div>
      </div>
      ...
      <div className="bg-white px-5 py-3">
        {isLoading ? (
          ...
          <div className="grid grid-cols-3 gap-4 text-center">
            <div>
              <p className="text-2xl font-semibold text-gray-900">{stats.totalMentorships}</p>
              <p className="text-xs text-gray-500">Total Mentorships</p>
            </div>
            <div>
              <p className="text-2xl font-semibold text-gray-900">{stats.activeMentorships}</p>
              <p className="text-xs text-gray-500">Active Mentorships</p>
            </div>
            <div>
              <p className="text-2xl font-semibold text-indigo-600 flex items-center justify-center">
      ...
      <div className="bg-gray-50 px-5 py-3">
        <div className="flex justify-between items-center text-sm">
          <Link href="/mentorship" className="font-medium text-indigo-600 hover:text-indigo-500">
            View My Mentorships
          </Link>
          <Link href="/mentors" className="font-medium text-indigo-600 hover:text-indigo-500">
            Find a Mentor
          </Link>
        </div>
      </div>
