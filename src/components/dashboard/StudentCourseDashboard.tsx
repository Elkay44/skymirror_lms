...
export default function StudentCourseDashboard({ courses = [] }: StudentCourseDashboardProps) {
  ...
  const [visualMode, setVisualMode] = useState<'list' | 'grid'>('grid');
  ...
  useEffect(() => {
    ...
    const timer = setTimeout(() => {
      if (courses.length > 0) {
        ...
        setLoadingError("No courses found or you're not enrolled in any courses.");
        setLoading(false);
      }
    }, 1000);
  ...
  const handleTabChange = (tab: string) => {
    setAnimateTab(false);
    setActiveTab(tab);
    // Small delay to trigger animation after tab content has changed
    setTimeout(() => {
      setAnimateTab(true);
    }, 50);
  };
      ...
      <div className="bg-white border-b shadow-sm">
        <div className="container py-4 flex items-center justify-between">
          <div className="flex items-center space-x-4">
            ...
            <h1 className="text-xl font-semibold text-slate-800">{availableCourses[0].title}</h1>
            <Badge variant="secondary" className="ml-2">
              {availableCourses[0].category}
            </Badge>
          </div>
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-4">
          <Card className="h-[140px]">
            <CardHeader className="flex flex-row items-center justify-between space-y-0 pb-2 h-[48px]">
              <CardTitle className="text-sm font-medium">Overall Progress</CardTitle>
              <BarChart className="h-4 w-4 text-muted-foreground" />
            </CardHeader>
            <CardContent className="h-[76px]">
          ...
          <Card className="h-[140px]">
            ...
            <CardContent className="h-[76px]">
              ...
              <Progress value={completedModulesPercent} className="mt-2" />
            </CardContent>
          </Card>
          <Card className="h-[140px]">
            <CardHeader className="flex flex-row items-center justify-between space-y-0 pb-2 h-[48px]">
            ...
            <CardContent className="h-[76px]">
              ...
              <Progress value={completedProjectsPercent} className="mt-2" />
            </CardContent>
          </Card>
          <Card className="h-[140px]">
            <CardHeader className="flex flex-row items-center justify-between space-y-0 pb-2 h-[48px]">
        ...
        {/* Full-width Tabs Section - Aligned with Stats Row */}
        <div className="w-full mt-8 mb-6">
          <Tabs defaultValue="overview" className="w-full" onValueChange={(value) => {
            ...
            <div className="relative mb-4">
              <TabsList className="bg-muted/50 p-1.5 flex-nowrap overflow-x-auto w-full md:flex md:justify-start gap-1 rounded-md shadow-sm">
                  <TabsTrigger value="overview" className="gap-1.5 px-4 py-2.5 rounded-md data-[state=active]:bg-white data-[state=active]:shadow-md data-[state=active]:text-blue-600">
                  ...
                  <TabsTrigger value="modules" className="gap-1.5 px-4 py-2.5 rounded-md data-[state=active]:bg-white data-[state=active]:shadow-md data-[state=active]:text-blue-600">
                    <BookOpen className="h-4 w-4" /> <span className="sm:inline">Modules</span>
                  </TabsTrigger>
                  <TabsTrigger value="projects" className="gap-1.5 px-4 py-2.5 rounded-md data-[state=active]:bg-white data-[state=active]:shadow-md data-[state=active]:text-blue-600">
                    <FileText className="h-4 w-4" /> <span className="sm:inline">Projects</span>
                  </TabsTrigger>
                  <TabsTrigger value="commits" className="gap-1.5 px-4 py-2.5 rounded-md data-[state=active]:bg-white data-[state=active]:shadow-md data-[state=active]:text-blue-600">
                    <GitCommit className="h-4 w-4" /> <span className="sm:inline">Commits</span>
                  </TabsTrigger>
                  <TabsTrigger value="marks" className="gap-1.5 px-4 py-2.5 rounded-md data-[state=active]:bg-white data-[state=active]:shadow-md data-[state=active]:text-blue-600 relative">
                  ...
                  <TabsTrigger value="forum" className="gap-1.5 px-4 py-2.5 rounded-md data-[state=active]:bg-white data-[state=active]:shadow-md data-[state=active]:text-blue-600 relative">
              ...
              <TabsContent value="overview" className={`w-full ${activeTab === "overview" && animateTab ? "animate-fadeIn" : ""}`}>
                    ...
                    <Card className="border-0 shadow-md overflow-hidden">
                      ...
                      <CardHeader className="pb-3 bg-gradient-to-r from-blue-50/60 to-indigo-50/60">
                        <div className="flex items-center gap-3">
                          <div className="h-12 w-12 rounded-full bg-gradient-to-r from-indigo-500 to-blue-500 flex items-center justify-center text-white font-semibold text-xl">
                            {availableCourses[0].progress}%
                          </div>
                          <div>
                            <h2 className="text-xl font-bold text-transparent bg-clip-text bg-gradient-to-r from-indigo-600 to-blue-500">{availableCourses[0].title}</h2>
                            <div className="flex flex-wrap gap-2 mt-1">
                              <Badge variant="secondary" className="bg-indigo-100 text-indigo-700">
                                <CalendarDays className="h-3 w-3 mr-1" /> Started: {availableCourses[0].startDate?.toLocaleDateString()}
                              </Badge>
                              <Badge variant="secondary" className="bg-blue-100 text-blue-700">
                                <CalendarCheck className="h-3 w-3 mr-1" /> Ends: {availableCourses[0].endDate?.toLocaleDateString()}
                              </Badge>
                            </div>
                          </div>
                        </div>
                      ...
                      <CardContent className="py-4 px-6 space-y-4">
                        <div className="space-y-1">
                          ...
                          <Progress value={availableCourses[0].progress} className="h-2.5 bg-blue-100" />
                          <span className="text-sm text-slate-500">{availableCourses[0].progress}% Completed</span>
                        </div>
                        <p className="text-slate-700 leading-relaxed">
                          {availableCourses[0].description || "No description provided for this course."}
                        </p>
                    ...
                    <Card className="border-0 shadow-md overflow-hidden">
                      ...
                      <CardContent className="p-0">
                        <div className="divide-y divide-slate-100">
                          {(availableCourses[0].activities || mockActivities).map((activity: Activity) => (
                            <div key={activity.id} className="flex items-center gap-4 px-6 py-3 hover:bg-slate-50 transition-colors">
                              ...
                              <div className="flex-1">
                                <div className="flex items-center gap-1 text-sm">
                                  <span className="text-gray-600 font-medium">{activity.type === 'lesson' ? 'You' : activity.title.split(' ')[0]}</span>
                        ...
                        <div className="divide-y divide-slate-100">
                          {projects.filter(p => !p.completed && p.dueDate).sort((a,b) => (a.dueDate?.getTime() || 0) - (b.dueDate?.getTime() || 0)).map((project) => (
                            <div key={project.id} className="flex items-center gap-4 px-6 py-3 hover:bg-slate-50 transition-colors">
                              <span className={`h-3 w-3 rounded-full ${project.dueDate ? (new Date() > project.dueDate ? 'bg-red-500' : 'bg-green-500') : 'bg-slate-300'}`} />
                              <div className="flex-1">
                              ...
                              <Button variant="outline" size="sm" onClick={() => handleNavigateToProject(availableCourses[0].id, project.id)}>
                      ...
                      <CardContent className="flex items-center gap-4 py-4 px-6">
                        <Avatar className="h-16 w-16">
                          <AvatarFallback className="bg-purple-100 text-purple-700 text-2xl font-semibold">
                            {availableCourses[0].instructor.split(' ').map((n: string) => n[0]).join('')}
                          </AvatarFallback>
                        </Avatar>
                        <div>
                          <h3 className="text-lg font-semibold text-slate-800">{availableCourses[0].instructor}</h3>
                    ...
                    <Card className="border-0 shadow-md">
                      ...
                      <CardContent className="py-4 px-6 text-sm text-slate-600 space-y-2">
                        <div className="flex items-center gap-2">
                          ...
                          <span>Started: {availableCourses[0].startDate?.toLocaleDateString()}</span>
                        </div>
                        <div className="flex items-center gap-2">
                          <CalendarCheck className="h-4 w-4 text-slate-500" />
                          <span>Ends: {availableCourses[0].endDate?.toLocaleDateString()}</span>
                        </div>
                        <div className="flex items-center gap-2">
                        ...
                        {availableCourses[0].category && (
                          <div className="flex items-center gap-2">
                            ...
                            <span>Category: {availableCourses[0].category}</span>
                          </div>
                        )}
                      </CardContent>
                    </Card>
                ...
                <div className="space-y-6">
                  ...
                  {availableCourses[0].modules.length > 0 ? (
                                  ...
                                  {moduleItem.lessons.map((lesson: DashboardLesson) => (
                                    <li key={lesson.id} className="flex items-center justify-between py-2 px-3 bg-slate-50 rounded-md">
                                      ...
                                      <div className="flex items-center gap-2">
                                        ...
                                        <Button variant="ghost" size="sm" onClick={() => handleNavigateToLesson(availableCourses[0].id, lesson.id)}>
                    ...
                    <div className="text-center py-10">
                      ...
                      <h3 className="text-lg font-medium text-slate-900 mb-1">No modules available</h3>
                        ...
                        {projects.map((project) => (
                          <TableRow key={project.id}>
                            ...
                            <TableCell className="text-right">
                              <Button variant="ghost" size="sm" onClick={() => handleNavigateToProject(availableCourses[0].id, project.id)}>
                        ...
                        <Card key={commit.id} className="shadow-sm">
                          <CardContent className="flex items-center justify-between p-4">
                            ...
                            <div className="flex items-center gap-3">
                              ...
                              <Button variant="ghost" size="sm" onClick={() => router.push(`/courses/${availableCourses[0].id}/commits/${commit.id}`)}>
                                <ExternalLink className="h-4 w-4" />
                              </Button>
                            </div>
                          </CardContent>
              ...
              <TabsContent value="marks" className={`${activeTab === "marks" && animateTab ? "animate-fadeIn" : ""}`}>
                <div className="space-y-6">
                      ...
                      <div className="space-y-6">
                        ...
                        <div className="flex items-center opacity-50">
                          <div className="w-full">
                            <div className="flex items-center justify-between mb-2">
                              <div className="space-y-1">
                                <p className="text-sm font-medium leading-none">Final Project</p>
                  ...
                  <Card className="shadow-sm">
                    ...
                    <CardContent className="pt-0">
                      <div className="space-y-4">
                        <div className="p-4 rounded-lg bg-muted/70 border border-muted">
                          <div className="flex items-start gap-3">
                            ...
                            <div>
                              ...
                              <div className="flex items-center mt-2 gap-2">
                                <Badge variant="secondary" className="text-xs font-normal bg-green-100 text-green-700">Outstanding</Badge>
