          ...
          >
                ...
                <div className="md:col-span-2 space-y-4 lg:space-y-6">
                  ...
                  <Card className="border-0 shadow-md overflow-hidden">
                    ...
                    <CardHeader className="pb-3 bg-gradient-to-r from-indigo-50 to-blue-50/30">
                      <div className="flex justify-between items-center min-w-0">
                        <CardTitle className="text-base font-medium flex items-center gap-2 break-words min-w-0">
                          <CheckCircle className="h-4 w-4 text-indigo-600" />
                          Course Hero Stats
                        </CardTitle>
                        <Badge variant="outline" className="text-xs font-medium px-2 py-0.5 h-5 bg-white text-indigo-700 border-indigo-200 shadow-sm break-words">
                          {currentCourse.level}
                        </Badge>
                      </div>
                    </CardHeader>
                    <CardContent className="p-4 pt-0">
                      <div className="flex justify-between items-center min-w-0">
                        ...
                        <div className="flex items-center gap-3 min-w-0">
                          <div className="h-12 w-12 rounded-full bg-gradient-to-r from-indigo-500 to-blue-500 flex items-center justify-center text-white font-semibold text-xl break-words min-w-0">
                            {currentCourse.progress}%
                          </div>
                          <div>
                            <h2 className="text-xl font-bold text-transparent bg-clip-text bg-gradient-to-r from-indigo-600 to-blue-500 break-words">{currentCourse.title}</h2>
                          </div>
                        </div>
                      </div>
                    </CardContent>
                  ...
                  <Card className="border-0 shadow-md overflow-hidden">
                    ...
                    <CardHeader className="pb-3 bg-gradient-to-r from-amber-50 to-yellow-50/30">
                      <div className="flex justify-between items-center min-w-0">
                        ...
                        <Badge variant="outline" className="text-xs font-medium px-2 py-0.5 h-5 bg-white text-amber-700 border-amber-200 shadow-sm break-words">
                          4 new this week
                        </Badge>
                      </div>
                    </CardHeader>
                    <CardContent className="p-0">
                      <div className="divide-y divide-slate-100">
                        {[
                          ...
                          <div key={i} className="flex items-center gap-3 p-3 hover:bg-slate-50 min-w-0">
                            ...
                            <div className="flex-1 min-w-0 min-w-0">
                              <div className="flex items-center gap-2 min-w-0">
                                <p className="text-sm font-medium truncate break-words">{material.title}</p>
                                {material.isNew && (
                              ...
                              <div className="flex gap-3 text-xs text-muted-foreground min-w-0">
                  ...
                  <Card className="border-0 shadow-md overflow-hidden">
                    ...
                    <CardContent className="p-4 space-y-4">
                      <div>
                        <h3 className="text-lg font-semibold text-slate-800 break-words">{Math.round(100 - currentCourse.progress)}% Remaining</h3>
                        <p className="text-sm text-slate-600 break-words">Complete these requirements to earn your certificate</p>
                      </div>
                      <div className="space-y-3">
                        <div className="space-y-1">
                          <div className="flex justify-between text-sm break-words min-w-0">
                            <span className="text-slate-600">Modules</span>
                            <span className="font-medium break-words">9/12</span>
                          </div>
                        ...
                        <div className="space-y-1">
                          <div className="flex justify-between text-sm break-words min-w-0">
                            ...
                            <span className="font-medium break-words">24/36</span>
                          </div>
                        ...
                        <div className="space-y-1">
                          <div className="flex justify-between text-sm break-words min-w-0">
                            ...
                            <span className="font-medium break-words">3/4</span>
                          </div>
                          <Progress value={75} className="h-2" />
                        </div>
                      </div>
                ...
                <div className="space-y-5">
                  ...
                  <Card className="border-0 border-blue-100 shadow-md overflow-hidden">
                    ...
                    <CardHeader className="pb-3 bg-gradient-to-r from-blue-50 to-blue-100/30">
                      <div className="flex justify-between items-center min-w-0">
                        ...
                        <Badge variant="outline" className="text-xs font-medium px-2 py-0.5 h-5 bg-white text-blue-700 border-blue-200 shadow-sm break-words">
                    ...
                    <CardContent className="p-4 space-y-4">
                      <div>
                        <h4 className="font-medium text-blue-800 break-words">{currentCourse.nextSession.title}</h4>
                        <Badge variant="outline" className="bg-blue-100/80 border-blue-200 text-blue-700 text-xs font-normal mt-1">
                          In 2 days
                        </Badge>
                      </div>
                      <div className="flex items-center gap-2 text-slate-500 text-sm break-words min-w-0">
                  ...
                  <Card className="border-0 shadow-md overflow-hidden">
                    ...
                    <CardHeader className="pb-3 bg-gradient-to-r from-green-50 to-emerald-50/30">
                      <div className="flex justify-between items-center min-w-0">
                        ...
                        <Badge variant="outline" className="text-xs font-medium px-2 py-0.5 h-5 bg-white text-green-700 border-green-200 shadow-sm break-words">
                          Last 7 days
                        </Badge>
                      </div>
                    </CardHeader>
                    <CardContent className="p-0">
                      <div className="divide-y divide-slate-100">
                        {[
                          ...
                          <div key={i} className="flex items-start gap-3 p-3 hover:bg-slate-50 min-w-0">
                            <div className={`mt-0.5 p-1.5 ${item.bgColor} rounded-md`}>
                              <item.icon className={`h-3.5 w-3.5 ${item.color}`} />
                            </div>
                            <div className="flex-1 min-w-0">
                              <p className="text-sm font-medium break-words">{item.activity}</p>
                  ...
                  <Card className="border-0 shadow-md overflow-hidden">
                    ...
                    <CardHeader className="pb-3 bg-gradient-to-r from-indigo-50 to-purple-50/30">
                      <CardTitle className="text-base font-medium break-words">Your Instructor</CardTitle>
                    </CardHeader>
                    <CardContent className="p-4 pt-0">
                      <div className="flex items-center gap-4 min-w-0">
                        ...
                        <div className="space-y-0.5">
                          <h4 className="text-base font-medium flex items-center gap-1.5 break-words min-w-0">
            ...
            <TabsContent value="modules" className={`${activeTab === "modules" && animateTab ? "animate-fadeIn" : ""}`}>
              <div className="space-y-4">
                <div className="flex items-center justify-between mb-6 min-w-0">
                  <h2 className="text-xl font-semibold break-words">Course Modules</h2>
                  <div className="flex items-center gap-2 min-w-0">
                        ...
                        <div key={i} className="p-4 hover:bg-slate-50">
                          <div className="flex items-center justify-between mb-2 min-w-0">
                            <div className="flex items-center gap-3 min-w-0">
                              ...
                              <div>
                                <h3 className="font-medium text-base flex items-center gap-2 break-words min-w-0">
                                  {module.title}
                                ...
                                <p className="text-sm text-slate-500 break-words">{module.description}</p>
                              </div>
                            </div>
                          ...
                          <div className="mt-3">
                            <div className="flex justify-between text-xs text-slate-500 mb-1.5 min-w-0">
                              <div className="flex items-center gap-3 min-w-0">
            ...
            <TabsContent value="projects" className={`${activeTab === "projects" && animateTab ? "animate-fadeIn" : ""}`}>
              <div className="space-y-4">
                <div className="flex items-center justify-between mb-6 min-w-0">
                  <h2 className="text-xl font-semibold break-words">Course Projects</h2>
                      ...
                      {[
                        ...
                        <Card key={i} className="border shadow-sm overflow-hidden">
                          ...
                          <CardContent className="pb-2 pt-0">
                            <div className="flex justify-between items-center text-sm text-slate-600 mb-2 break-words min-w-0">
                              <div className="flex items-center gap-1 min-w-0">
                                <CalendarRange className="h-3.5 w-3.5" />
                                <span>Due: {project.dueDate}</span>
                              </div>
                              {project.grade && <div className="font-medium text-green-600 break-words">Grade: {project.grade}</div>}
                            </div>
                          ...
                          <CardFooter className="pt-0 pb-3 flex justify-end gap-2 min-w-0">
            ...
            <TabsContent value="marks" className={`${activeTab === "marks" && animateTab ? "animate-fadeIn" : ""}`}>
              <div className="space-y-4">
                <div className="flex items-center justify-between mb-6 min-w-0">
                  <h2 className="text-xl font-semibold break-words">Course Marks & Grades</h2>
                  <Button variant="outline" size="sm" className="text-xs gap-1">
                    ...
                    <div className="grid grid-cols-1 lg:grid-cols-3 gap-4 mb-6">
                      <Card className="bg-slate-50 border-0 shadow-sm">
                        <CardContent className="pt-6 text-center">
                          <div className="text-4xl font-bold text-slate-800 break-words">87%</div>
                          <p className="text-sm text-slate-500 mt-1 break-words">Overall Average</p>
                        </CardContent>
                      </Card>
                      <Card className="bg-slate-50 border-0 shadow-sm">
                        <CardContent className="pt-6 text-center">
                          <div className="text-4xl font-bold text-amber-600 break-words">A-</div>
                          <p className="text-sm text-slate-500 mt-1 break-words">Current Grade</p>
                        </CardContent>
                      </Card>
                      <Card className="bg-slate-50 border-0 shadow-sm">
                        <CardContent className="pt-6 text-center">
                          <div className="text-4xl font-bold text-green-600 break-words">92%</div>
                          <p className="text-sm text-slate-500 mt-1 break-words">Attendance</p>
                        </CardContent>
                      </Card>
                    </div>
                    
                    <h3 className="text-sm font-medium mb-3 break-words">Assessment Breakdown</h3>
                    <div className="space-y-4">
                      {[
                        ...
                        <div key={i} className="flex flex-col min-w-0">
                          <div className="flex justify-between items-center mb-1 min-w-0">
                            ...
                            <div className="text-sm text-slate-500 break-words">
                              <span className="font-medium text-slate-700 break-words">{item.score}%</span>
                ...
                <Card>
                  <CardHeader className="pb-3">
                    <CardTitle className="text-base break-words">Recent Assessments</CardTitle>
                  </CardHeader>
                  <CardContent className="p-0">
                    <div className="divide-y divide-slate-100">
                      {[
                        ...
                        <div key={i} className="flex justify-between items-center p-4 hover:bg-slate-50 min-w-0">
                          <div>
                            <h4 className="font-medium text-sm break-words">{assessment.name}</h4>
            ...
            <TabsContent value="resources" className={`${activeTab === "resources" && animateTab ? "animate-fadeIn" : ""}`}>
              <div className="space-y-4">
                <div className="flex items-center justify-between mb-6 min-w-0">
                  <h2 className="text-xl font-semibold break-words">Course Resources</h2>
                  <div className="flex items-center gap-2 min-w-0">
                    <Button variant="outline" size="sm" className="text-xs gap-1">
                  ...
                  <CardContent>
                    <div className="grid grid-cols-1 gap-2">
                      {[
                        ...
                        <div key={i} className="flex items-center justify-between p-3 rounded-lg border hover:bg-slate-50 min-w-0">
                          <div className="flex items-start gap-3 min-w-0">
                            ...
                            <div>
                              <div className="flex items-center gap-2 min-w-0">
                                <h3 className="font-medium break-words">{resource.title}</h3>
                                {resource.isNew && <Badge className="bg-green-100 text-green-800 hover:bg-green-100 text-xs">NEW</Badge>}
                              </div>
                              <p className="text-sm text-slate-500 break-words">{resource.description}</p>
                ...
                <Card>
                  <CardHeader className="pb-3">
                    <CardTitle className="text-base break-words">Recommended Readings</CardTitle>
                  </CardHeader>
                  <CardContent>
                    <div className="space-y-4">
                      {[
                        ...
                        <div key={i} className="flex gap-3 min-w-0">
                          ...
                          <div>
                            ...
                            <p className="text-sm text-slate-600 break-words">by {book.author}</p>
                            <p className="text-sm text-slate-500 break-words">{book.description}</p>
            ...
            <TabsContent value="forums" className={`${activeTab === "forums" && animateTab ? "animate-fadeIn" : ""}`}>
              <div className="space-y-4">
                <div className="flex items-center justify-between mb-6 min-w-0">
                  <h2 className="text-xl font-semibold break-words">Discussion Forums</h2>
                  <div className="flex items-center gap-2 min-w-0">
                    <Button variant="outline" size="sm" className="text-xs gap-1">
                ...
                <Card>
                  ...
                  <CardContent className="p-0">
                    <div className="divide-y divide-slate-100">
                      {[
                        ...
                        <div key={i} className="flex items-center justify-between py-4 px-4 hover:bg-slate-50 min-w-0">
                          <div className="flex-1 min-w-0">
                            <div className="flex items-center gap-2 min-w-0">
                              {thread.isPinned && <span className="text-slate-500 text-xs">📌</span>}
                              <h3 className="font-medium hover:text-blue-700 cursor-pointer break-words">{thread.title}</h3>
                            ...
                            <div className="flex items-center gap-3 mt-1 text-xs text-slate-500 min-w-0">
                              ...
                              {thread.hasInstructorReply && <span className="text-green-600 font-medium break-words">Instructor replied</span>}
                            </div>
                          </div>
                          <div className="flex items-center gap-4 lg:gap-6 text-xs text-slate-500 min-w-0">
                            <div className="text-center">
                              <div className="font-medium text-slate-700 break-words">{thread.replies}</div>
                              <div>Replies</div>
                            </div>
                            <div className="text-center">
                              <div className="font-medium text-slate-700 break-words">{thread.views}</div>
                              <div>Views</div>
                            </div>
                  ...
                  <CardFooter className="flex justify-between py-3 border-t min-w-0">
                    <div className="text-sm text-slate-500 break-words">Showing 5 of 24 discussions</div>
                    <div className="flex items-center gap-1 min-w-0">
                ...
                <Card>
                  <CardHeader className="pb-3">
                    <CardTitle className="text-base break-words">Important Announcements</CardTitle>
                  </CardHeader>
                  <CardContent className="p-0">
                    <div className="divide-y divide-slate-100">
                      {[
                        ...
                        <div key={i} className="py-4 px-4 hover:bg-slate-50">
                          <div className="flex items-center justify-between mb-2 min-w-0">
                            <h3 className="font-medium flex items-center gap-2 break-words min-w-0">
                              {announcement.title}
                          ...
                          <p className="text-sm text-slate-600 break-words">{announcement.content}</p>
                          <Button variant="link" className="h-7 px-0 mt-1 text-sm break-words">
                            Read more
                          </Button>
                        </div>
                      ))}
            ...
            <TabsContent value="commits" className={`${activeTab === "commits" && animateTab ? "animate-fadeIn" : ""}`}>
              <div className="space-y-4">
                <div className="flex items-center justify-between mb-6 min-w-0">
                  <h2 className="text-xl font-semibold break-words">Your Commits</h2>
                  ...
                  <CardContent className="p-0">
                    <div className="divide-y divide-slate-100">
                      {[
                        ...
                        <div key={i} className="flex flex-col p-4 hover:bg-slate-50 min-w-0">
                          <div className="flex justify-between items-start mb-2 min-w-0">
                            <div className="flex gap-2 items-center min-w-0">
                              <span className="font-mono bg-slate-100 px-2 py-0.5 rounded text-slate-700 text-sm break-words">
                                {commit.hash}
                              </span>
                            ...
                            <Badge variant="outline" className={commit.status === 'success' ? 'text-xs h-5 px-1.5 border-green-200 bg-green-50 text-green-700' : 'text-xs h-5 px-1.5 border-red-200 bg-red-50 text-red-700'}>
                              {commit.status === 'success' ? 
                                <div className="flex items-center gap-1 min-w-0"><CheckCircle className="h-3 w-3" /> Success</div> : 
                                <div className="flex items-center gap-1 min-w-0"><AlertCircle className="h-3 w-3" /> Failed</div>
                              }
                            </Badge>
                          </div>
                          <p className="text-sm font-medium mb-1 break-words">{commit.message}</p>
                          <div className="flex justify-between items-center mt-2 min-w-0">
                            <div className="text-xs text-slate-500">
                              <span className="font-medium text-slate-700 break-words">{commit.project}</span>
