    ...
    <div className="h-screen flex overflow-hidden bg-gray-100 min-w-0">
      ...
      {sidebarOpen && (
        <div className="fixed inset-0 z-40 flex md:hidden min-w-0">
          ...
          ></div>
          <div className="relative flex-1 flex flex-col max-w-xs w-full bg-blue-800 min-w-0">
                ...
                {navigation.map((item) => {
                  ...
                  return (
                    <Link
                      key={item.name}
                      href={item.href}
                      className="group flex items-center px-2 py-2 text-base font-medium rounded-md text-white hover:bg-blue-700 break-words min-w-0"
                    >
            ...
            <div className="flex-shrink-0 flex border-t border-blue-700 p-4 min-w-0">
              <div className="flex items-center min-w-0">
                <div>
                  <div className="h-8 w-8 rounded-full bg-blue-600 flex items-center justify-center text-white font-bold break-words min-w-0">
                ...
                <div className="ml-3">
                  ...
                  <button
                    onClick={() => signOut()}
                    className="text-sm font-medium text-blue-300 hover:text-white flex items-center break-words min-w-0"
                  >
      ...
      <div className="hidden md:flex md:flex-shrink-0 min-w-0">
        <div className="flex flex-col w-64 min-w-0">
          <div className="flex flex-col h-0 flex-1 bg-blue-800 min-w-0">
                ...
                {navigation.map((item) => {
                  ...
                  return (
                    <Link
                      key={item.name}
                      href={item.href}
                      className="group flex items-center px-2 py-2 text-sm font-medium rounded-md text-white hover:bg-blue-700 break-words min-w-0"
                    >
            ...
            <div className="flex-shrink-0 flex border-t border-blue-700 p-4 min-w-0">
              <div className="flex items-center min-w-0">
                ...
                <div className="ml-3">
                  ...
                  <button
                    onClick={() => signOut()}
                    className="text-xs font-medium text-blue-300 hover:text-white flex items-center break-words min-w-0"
                  >
