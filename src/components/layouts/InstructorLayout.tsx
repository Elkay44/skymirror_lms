            ...
            <div className="flex-shrink-0 flex border-t border-indigo-700 p-4">
              <div className="flex items-center">
                ...
                <div className="ml-3">
                  ...
                  <button
                    onClick={() => signOut()}
                    className="text-sm font-medium text-indigo-300 hover:text-white flex items-center"
                  >
            ...
            <div className="flex-shrink-0 flex border-t border-indigo-700 p-4">
              <div className="flex items-center">
                ...
                <div className="ml-3">
                  ...
                  <button
                    onClick={() => signOut()}
                    className="text-xs font-medium text-indigo-300 hover:text-white flex items-center"
                  >
