  ...
  return (
    <div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center z-50 p-4 min-w-0">
      <motion.div 
        ...
        className="bg-white rounded-lg w-full max-w-4xl max-h-[90vh] overflow-hidden flex flex-col min-w-0 overflow-hidden"
      >
        ...
        <div className="overflow-y-auto p-6 flex-grow min-w-0">
          {error && (
          ...
          <form onSubmit={handleSubmit}>
            {!project && (
              <div className="mb-6">
                <h3 className="text-lg font-medium text-gray-900 mb-2 break-words">Select Project Submission</h3>
                ...
                <div className="flex items-center gap-2 mb-4 min-w-0">
                  <input
                    ...
                    className="flex-1 px-3 py-2 border border-gray-300 rounded-md shadow-sm focus:outline-none focus:ring-blue-500 focus:border-blue-500 min-w-0"
                  />
                  <button
                    type="button"
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4 lg:gap-6 mb-6">
              <div>
                <label htmlFor="category" className="block text-sm font-medium text-gray-700 mb-1 break-words">
                  Category*
                </label>
                <select
                  id="category"
              ...
              <div>
                <label htmlFor="tags" className="block text-sm font-medium text-gray-700 mb-1 break-words">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4 lg:gap-6 mb-6">
              <div>
                <label htmlFor="demoUrl" className="block text-sm font-medium text-gray-700 mb-1 break-words">
                  Demo URL
                </label>
                <input
                  id="demoUrl"
              ...
              <div>
                <label htmlFor="repositoryUrl" className="block text-sm font-medium text-gray-700 mb-1 break-words">
                  Repository URL
                </label>
                <input
                  id="repositoryUrl"
            ...
            <div className="mb-6">
              <div className="flex items-center justify-between mb-1 min-w-0">
                <label htmlFor="image" className="block text-sm font-medium text-gray-700 break-words">
                  Project Image
                </label>
                {previewUrl && (
                  <button
                    ...
                    className="text-sm text-red-600 hover:text-red-800 break-words"
                  >
                    Remove image
                  </button>
                )}
              ...
              {!previewUrl && (
                <label
                  htmlFor="image"
                  className="mt-2 inline-flex items-center px-4 py-2 border border-gray-300 shadow-sm text-sm font-medium rounded-md text-gray-700 bg-white hover:bg-gray-50 cursor-pointer break-words min-w-0"
                >
                  Select Image
                </label>
              )}
            ...
            <div className="mb-6 flex items-center min-w-0">
              ...
              />
              <label htmlFor="featured" className="ml-2 block text-sm text-gray-900 break-words">
        ...
        <div className="bg-gray-50 border-t border-gray-200 px-6 py-4 flex justify-end min-w-0">
          <button
            onClick={onClose}
            className="px-4 py-2 border border-gray-300 rounded-md shadow-sm text-sm font-medium text-gray-700 bg-white hover:bg-gray-50 mr-3 break-words"
          >
            Cancel
          </button>
          ...
          <button
            ...
            className="px-4 py-2 border border-transparent rounded-md shadow-sm text-sm font-medium text-white bg-blue-600 hover:bg-blue-700 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-blue-500 disabled:bg-blue-300 flex items-center break-words min-w-0"
          >
            {loading ? (
              <>
