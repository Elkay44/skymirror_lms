    ...
    return (
      <div className="min-h-screen flex items-center justify-center bg-gray-50 dark:bg-gray-900">
        <div className="text-center">
          <div className="text-red-500 text-lg mb-4">{error || 'Quiz not found'}</div>
          <Link 
            ...
            <div className="bg-white dark:bg-gray-800 rounded-lg shadow-sm border border-gray-200 dark:border-gray-700 p-6">
              ...
              <div className="space-y-2">
                ...
                <Link
                  ...
                  className="block w-full px-3 py-2 text-center text-sm bg-purple-50 dark:bg-purple-900 hover:bg-purple-100 dark:hover:bg-purple-800 rounded-lg text-purple-700 dark:text-purple-300"
                >
                  View Analytics
                </Link>
              </div>
