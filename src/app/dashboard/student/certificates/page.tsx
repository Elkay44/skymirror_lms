        ...
        {isLoading ? (
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
            {certificates.map((certificate) => (
              <div key={certificate.id} className="bg-white rounded-lg shadow overflow-hidden flex flex-col">
                ...
                <div className="p-5 flex-grow">
                  <h3 className="text-lg font-medium text-gray-900 mb-1">{certificate.course.title}</h3>
                ...
                <div className="bg-gray-50 px-5 py-3 border-t border-gray-200">
                  <div className="flex justify-between space-x-2">
                    <Link
                      ...
                      target="_blank"
                      className="inline-flex items-center px-3 py-2 border border-gray-300 shadow-sm text-sm leading-4 font-medium rounded-md text-gray-700 bg-white hover:bg-gray-50 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-blue-500 flex-1 justify-center"
                    >
                      View
                    ...
                    <button
                      ...
                      className="inline-flex items-center px-3 py-2 border border-transparent text-sm leading-4 font-medium rounded-md shadow-sm text-white bg-blue-600 hover:bg-blue-700 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-blue-500 flex-1 justify-center"
                    >
                      Share
        ...
        {!isLoading && !error && (
          <div className="mt-12 bg-white rounded-lg shadow overflow-hidden">
            <div className="px-6 py-5 border-b border-gray-200">
              <h3 className="text-lg font-medium text-gray-900">About Your Blockchain Certificates</h3>
            </div>
            <div className="px-6 py-5 space-y-4">
              ...
              <div className="bg-blue-50 p-4 rounded-md">
                <h4 className="font-medium text-blue-800 mb-2">Sharing Your Certificates</h4>
              ...
              {certificates.length === 0 && (
                <div className="border-t border-gray-200 pt-4">
                  <h4 className="font-medium text-gray-900 mb-2">How to Get Your Certificate</h4>
                  <ol className="list-decimal pl-5 text-gray-600 space-y-2">
                    <li>
                      <span className="font-medium">Connect your wallet</span>: Go to the Wallet page and connect your Ethereum wallet.
                    </li>
                    <li>
                      <span className="font-medium">Complete all course requirements</span>: Finish all required projects and assessments.
                    </li>
                    <li>
                      <span className="font-medium">Certificate issuance</span>: Your instructor will issue your certificate to your wallet.
                    </li>
                  </ol>
                </div>
              )}
