...
export default function InstructorSecuritySettings() {
            ...
            <div>
              ...
              <div className="mt-1 relative rounded-md shadow-sm">
                <input
                  ...
                  className="block w-full border border-gray-300 rounded-md shadow-sm py-2 px-3 pr-10 focus:outline-none focus:ring-purple-500 focus:border-purple-500 sm:text-sm break-words"
            ...
            <div>
              ...
              <div className="mt-1">
                <input
                  ...
                  className="block w-full border border-gray-300 rounded-md shadow-sm py-2 px-3 focus:outline-none focus:ring-purple-500 focus:border-purple-500 sm:text-sm break-words"
          ...
          <div className="px-4 py-5 space-y-4">
            <div className="flex items-center justify-between min-w-0">
              ...
              <div className="ml-4 flex-shrink-0 min-w-0">
                <button
                  type="button"
                  className={`${twoFactorEnabled ? 'bg-purple-600' : 'bg-gray-200'} relative inline-flex h-6 w-11 flex-shrink-0 cursor-pointer rounded-full border-2 border-transparent transition-colors duration-200 ease-in-out focus:outline-none`}
            ...
            <div className="pt-4">
              <button
                type="button"
                className="text-sm font-medium text-purple-600 hover:text-purple-800 break-words"
