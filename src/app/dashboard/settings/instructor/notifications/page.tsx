      ...
      <form onSubmit={handleSubmit} className="space-y-4 lg:space-y-6">
        <div className="space-y-4">
          <div className="bg-purple-50 p-4 rounded-lg">
            <h3 className="text-sm font-medium text-purple-800 mb-3 break-words">Delivery Methods</h3>
          ...
          <div className="bg-white border border-gray-200 rounded-lg shadow-sm overflow-hidden">
            ...
            <div className="divide-y divide-gray-200">
              <div className="flex items-center justify-between p-4 min-w-0">
                <div>
                  <label htmlFor="course-enrollments" className="text-sm font-medium text-gray-700 break-words">Course Enrollments</label>
              ...
              <div className="flex items-center justify-between p-4 min-w-0">
                <div>
                  <label htmlFor="student-questions" className="text-sm font-medium text-gray-700 break-words">Student Questions</label>
              ...
              <div className="flex items-center justify-between p-4 min-w-0">
                <div>
                  <label htmlFor="course-feedback" className="text-sm font-medium text-gray-700 break-words">Course Feedback</label>
              ...
              <div className="flex items-center justify-between p-4 min-w-0">
                <div>
                  <label htmlFor="forum-activity" className="text-sm font-medium text-gray-700 break-words">Forum Activity</label>
