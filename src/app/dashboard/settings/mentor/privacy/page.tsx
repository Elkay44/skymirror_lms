      ...
      <form onSubmit={handleSubmit} className="space-y-8">
        ...
        <div className="bg-white border border-gray-200 rounded-lg shadow-sm overflow-hidden">
          <div className="px-4 py-5 border-b border-gray-200">
            ...
            <p className="mt-1 text-sm text-gray-500">Control who can see your mentor profile information</p>
          </div>
          ...
          <div className="px-4 py-5 space-y-6">
            ...
            <div className="space-y-4">
              <div className="flex items-center justify-between">
                <div>
                  <label htmlFor="show-mentorship-statistics" className="text-sm font-medium text-gray-700">Show Mentorship Statistics</label>
              ...
              <div className="flex items-center justify-between">
                <div>
                  <label htmlFor="show-availability" className="text-sm font-medium text-gray-700">Show Availability Schedule</label>
              ...
              <div className="flex items-center justify-between">
                <div>
                  <label htmlFor="show-expertise-areas" className="text-sm font-medium text-gray-700">Show Expertise Areas</label>
        ...
        <div className="bg-white border border-gray-200 rounded-lg shadow-sm overflow-hidden">
          <div className="px-4 py-5 border-b border-gray-200">
            <h3 className="text-lg font-medium text-gray-900">Mentorship & Communication</h3>
            <p className="mt-1 text-sm text-gray-500">Manage how students and potential mentees interact with you</p>
          </div>
          
          <div className="px-4 py-5 space-y-4">
            <div className="flex items-center justify-between">
              <div>
                <label htmlFor="allow-mentee-messaging" className="text-sm font-medium text-gray-700">Mentee Direct Messaging</label>
            ...
            <div className="flex items-center justify-between">
              <div>
                <label htmlFor="allow-mentee-reviews" className="text-sm font-medium text-gray-700">Mentee Reviews</label>
            ...
            <div className="flex items-center justify-between">
              <div>
                <label htmlFor="visible-to-non-mentees" className="text-sm font-medium text-gray-700">Visible to Non-Mentees</label>
