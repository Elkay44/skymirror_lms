      ...
      <form onSubmit={handleSubmit} className="space-y-6 lg:space-y-8">
        ...
        <div className="bg-white border border-gray-200 rounded-lg shadow-sm overflow-hidden overflow-hidden">
          <div className="px-4 py-5 border-b border-gray-200">
            ...
            <p className="mt-1 text-sm text-gray-500 break-words">Control who can see your profile information</p>
          </div>
          ...
          <div className="px-4 py-5 space-y-4 lg:space-y-6">
            ...
            <div className="space-y-4">
              <div className="flex items-center justify-between min-w-0">
                <div>
                  <label htmlFor="show-enrolled-courses" className="text-sm font-medium text-gray-700 break-words">Show Enrolled Courses</label>
              ...
              <div className="flex items-center justify-between min-w-0">
                <div>
                  <label htmlFor="show-achievements" className="text-sm font-medium text-gray-700 break-words">Show Achievements</label>
              ...
              <div className="flex items-center justify-between min-w-0">
                <div>
                  <label htmlFor="show-learning-activity" className="text-sm font-medium text-gray-700 break-words">Show Learning Activity</label>
        ...
        <div className="bg-white border border-gray-200 rounded-lg shadow-sm overflow-hidden overflow-hidden">
          <div className="px-4 py-5 border-b border-gray-200">
            <h3 className="text-lg font-medium text-gray-900 break-words">Platform Interactions</h3>
            <p className="mt-1 text-sm text-gray-500 break-words">Manage how you interact with other users and the platform</p>
          </div>
          
          <div className="px-4 py-5 space-y-4">
            <div className="flex items-center justify-between min-w-0">
              <div>
                <label htmlFor="allow-mentor-recommendations" className="text-sm font-medium text-gray-700 break-words">Mentor Recommendations</label>
            ...
            <div className="flex items-center justify-between min-w-0">
              <div>
                <label htmlFor="allow-course-recommendations" className="text-sm font-medium text-gray-700 break-words">Course Recommendations</label>
            ...
            <div className="flex items-center justify-between min-w-0">
              <div>
                <label htmlFor="allow-forum-tagging" className="text-sm font-medium text-gray-700 break-words">Forum Tagging</label>
