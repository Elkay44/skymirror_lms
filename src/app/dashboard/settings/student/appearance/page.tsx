...
export default function StudentAppearanceSettings() {
            ...
            <div>
              ...
              <div className="grid grid-cols-3 gap-3">
                <div 
                  ...
                  className={`flex flex-col items-center p-3 rounded-lg cursor-pointer transition-all ${themePreference === 'light' ? 'bg-blue-50 border-2 border-blue-500' : 'bg-white border border-gray-200 hover:bg-gray-50'}`}
                >
                ...
                <div 
                  ...
                  className={`flex flex-col items-center p-3 rounded-lg cursor-pointer transition-all ${themePreference === 'dark' ? 'bg-blue-50 border-2 border-blue-500' : 'bg-white border border-gray-200 hover:bg-gray-50'}`}
                >
                ...
                <div 
                  ...
                  className={`flex flex-col items-center p-3 rounded-lg cursor-pointer transition-all ${themePreference === 'system' ? 'bg-blue-50 border-2 border-blue-500' : 'bg-white border border-gray-200 hover:bg-gray-50'}`}
                >
          ...
          <div className="px-4 py-5 space-y-4">
            <div className="flex items-center justify-between">
              ...
              <div className="ml-4 flex-shrink-0">
                <button
                  type="button"
                  className={`${reducedMotion ? 'bg-blue-600' : 'bg-gray-200'} relative inline-flex h-6 w-11 flex-shrink-0 cursor-pointer rounded-full border-2 border-transparent transition-colors duration-200 ease-in-out focus:outline-none`}
            ...
            <div className="flex items-center justify-between">
              ...
              <div className="ml-4 flex-shrink-0">
                <button
                  type="button"
                  className={`${highContrast ? 'bg-blue-600' : 'bg-gray-200'} relative inline-flex h-6 w-11 flex-shrink-0 cursor-pointer rounded-full border-2 border-transparent transition-colors duration-200 ease-in-out focus:outline-none`}
